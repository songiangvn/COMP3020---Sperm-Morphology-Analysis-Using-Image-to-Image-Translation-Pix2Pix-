"""
Quick inference script for UNet to check results
"""
import os
import torch
...
def load_unet_model(checkpoint_path, device):
    ...
    model.eval()
    print(f"Loaded UNet from epoch {checkpoint['epoch']+1}")
...
def visualize_results(results, output_dir='./inference_unet'):
    ...
    for i, result in enumerate(results):
        ...
        axes[i, 1].set_title('UNet Generated')
        axes[i, 1].axis('off')
    ...
    plt.tight_layout()
    output_path = os.path.join(output_dir, 'unet_samples.png')
...
if __name__ == '__main__':
    ...
    checkpoint_path = './outputs_baselines/unet/unet_best.pth'
    data_dir = '/home/23giang.ns/ML_Project/virtual_stainning/both'
    num_samples = 5
    
    print("="*60)
    print("UNet Inference - Quick Check")
    print("="*60)
